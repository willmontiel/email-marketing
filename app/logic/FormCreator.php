...
{	
	...
	public function getHtmlForm(Form $form)
	{
		...
		$html_content = $this->getHtmlStyles() . '<form method="post" action="' . $this->getLinkAction($form) . '" class="sm-big-container" target="_top" style="width:' . $jsoncontent->properties_zone->size . 'px; background-color: ' . $jsoncontent->properties_zone->background_color . ';">';
