...
$sockets->exportrequest = $config->sockets->exportrequest;
$sockets->exporttochildren = $config->sockets->exporttochildren;
$sockets->exportfromchild = $config->sockets->exportfromchild;
