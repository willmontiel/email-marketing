...
class PermissionsDataBase
{
	...
	public function loadActions()
	{
		$this->action = array(
			...
			'customfield::create' => 22,
			'customfield::read' => 23,
			'customfield::update' => 24,
			'customfield::delete' => 25,
			
			'user::create' => 26,
			'user::read' => 27,
			'user::update' => 28,
			'user::delete' => 29,
			'user::login how any user' => 30,
			...
			'blockemail::read' => 35,
			'blockemail::block email' => 36,
			'blockemail::unblock email' => 37,
			...
			'statistic::read' => 52,
			'statistic::download' => 53,
			'statistic::share' => 54,
			
			'flashmessage::create' => 55,
			'flashmessage::read' => 56,
			'flashmessage::update' => 57,
			'flashmessage::delete' => 58,
			...
			'socialmedia::create' => 63,
			'socialmedia::read' => 64,
			'socialmedia::delete' => 65,
