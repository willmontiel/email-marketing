		...
		foreach ($data->contentData as $content) {
			if($content->selected) {
				...
				switch ($content->socialname) {
					case 'Facebook':
						$this->children[] = '<a href="https://www.facebook.com"><img src="' . $domain->imageUrl . '/images/follow_facebook_image.png" style="margin-right: 8px;"></a>';
						break;
					case 'Twitter':
						$this->children[] = '<a href="https://twitter.com"><img src="' . $domain->imageUrl . '/images/follow_twitter_image.png" style="margin-right: 8px;"></a>';
						break;
					case 'LinkedIn':
						$this->children[] = '<a href="https://linkedin.com"><img src="' . $domain->imageUrl . '/images/follow_linkedin_image.png" style="margin-right: 8px;"></a>';
						break;
					case 'Google Plus':
						$this->children[] = '<a href="https://plus.google.com"><img src="' . $domain->imageUrl . '/images/follow_google_plus_image.png" style="margin-right: 8px;"></a>';
						break;
				}	
			}
		}
