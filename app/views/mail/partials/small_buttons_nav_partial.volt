...
<div class="row">
	<div class="col-xs-12 col-sm-10 col-sm-offset-2 col-md-6 col-md-offset-6 col-lg-4 col-lg-offset-8">
		<ul class="list-inline pull-right mtop-5">
			<li class="small-btn-nav sm-btn-blue {{ activelnk=='compose'?'active':'' }}">
			...
			<li class="small-btn-nav sm-btn-blue {{ activelnk=='template'?'active':'' }}">
			...
			<li class="small-btn-nav sm-btn-blue {{ activelnk=='scheduledmail'?'active':'' }}">
			...
			<li class="small-btn-nav sm-btn-blue disabled {{ activelnk=='statisticsmail'?'active':'' }}">
