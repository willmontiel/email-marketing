...
<script type="text/javascript">
	...
	function sendData() {
		...
		$.ajax(
			...
			statusCode: {
				400: function() {
					$.gritter.add({class_name: 'gritter-error', title: '<i class="icon-warning-sign"></i> Atención', text: 'Ha enviado campos inválidos o vacíos, por favor verifique la información', sticky: false, time: 10000});
				},
				500: function() {
