	...
	<div class="row-fluid">
		<div class="news span4">
			<table class="table-condensed">
				<thead>
					<tr>
						<td colspan="5"><label class="label-gray-light-percent">Resumen de aperturas</label></td>
					</tr>
				</thead>
				<tbody>
							...
							<label class="label-green-percent">
								<table>
									<tr>
										...
										<td>{{'{{App.openData.opens}}'}}</td>
										<td>|</td>
										<td>{{'{{App.openData.percentage}}'}}%</td>
									</tr>
								</table>
							</label>
						</td>
