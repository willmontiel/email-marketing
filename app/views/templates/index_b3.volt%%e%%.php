...
<html>
    <head>
        ...
        <?php echo $this->tag->stylesheetLink('b3/css/bootstrap.css'); ?>
        <?php echo $this->tag->stylesheetLink('b3/css/font-awesome.css'); ?>
        <?php echo $this->tag->stylesheetLink('css/prstyles.css'); ?>
        <?php echo $this->tag->stylesheetLink('b3/css/sm-email-theme.css'); ?>
        <?php echo $this->tag->stylesheetLink('b3/vendors/css/bootstrap-editable.css'); ?>
        <?php echo $this->tag->stylesheetLink('b3/vendors/css/jquery.gritter.css'); ?>

		<!--[if lt IE 9]>
		<?php echo $this->tag->javascriptInclude('javascripts/vendor/html5shiv.js'); ?>
    ...
    <body>
		...
		<nav class="navbar navbar-default">
			<div class="container-fluid">
				...
				<!-- <p class="navbar-text">";s:12:"sectiontitle";a:1:{i:0;a:4:{s:4:"type";i:357;s:5:"value";s:16:"Titulo de pagina";s:4:"file";s:36:"../app/views/templates/index_b3.volt";s:4:"line";i:60;}}i:2;s:3086:"</p> -->
						...
						<ul class="nav pull-right">
							<li class="dropdown">
								...
								<ul class="dropdown-menu">
									...
									<li><a href="<?php echo $this->url->get('user'); ?>">Usuarios</a></li>
									<li><a href="<?php echo $this->url->get('process'); ?>">Procesos</a></li>
									<li><a href="<?php echo $this->url->get('scheduledmail/manage'); ?>">Programación de correos</a></li>
									<li><a href="<?php echo $this->url->get('flashmessage/index'); ?>">Mensajes administrativos</a></li>
									<li><a href="<?php echo $this->url->get('socialmedia/index'); ?>">Cuentas de Redes Sociales</a></li>
								</ul>
							</li>
						</ul>
-->
	...
	<div class="container-fluid">
		<div class="row">
			<div class="col-xs-12 col-sm-3 col-md-2 sidebar" style="height: 100%;">
				<div>
					<!-- Main nav -->
					<?php echo $this->partial('partials/menu_partial_b3'); ?>
				</div>
			</div>
			<div class="col-sx-12 col-sm-9 col-md-10">
				...
				<div class="container-fluid">
					<!-- Inicio de contenido -->
					";s:7:"content";a:1:{i:0;a:4:{s:4:"type";i:357;s:5:"value";s:42:"
						<!-- Aqui va el contenido -->
					";s:4:"file";s:36:"../app/views/templates/index_b3.volt";s:4:"line";i:147;}}i:3;s:2722:"
					<!-- Fin de contenido -->
				</div>
			</div>
		...
		<?php if ($this->chat->enabled) { ?>
			...
			<script type="text/javascript">
				...
				olark('api.visitor.updateEmailAddress', {
						emailAddress: '<?php echo $this->userObject->email; ?>'
				});
				olark('api.visitor.updateFullName', {
						fullName: '<?php echo $this->userObject->firstName; ?> <?php echo $this->userObject->lastName; ?>'
				});
				olark('api.chat.updateVisitorNickname', {
					snippet: '<?php echo $this->userObject->firstName; ?>'
				});
			</script>
		<?php } else { ?>
			<!-- No chat available -->
