...
<html>
    <head>
        ...
        <?php echo Phalcon\Tag::stylesheetLink('b3/css/bootstrap.css'); ?>
        <?php echo Phalcon\Tag::stylesheetLink('b3/css/font-awesome.css'); ?>
        <?php echo Phalcon\Tag::stylesheetLink('css/prstyles.css'); ?>
        <?php echo Phalcon\Tag::stylesheetLink('b3/css/sm-email-theme.css'); ?>
        <?php echo Phalcon\Tag::stylesheetLink('b3/vendors/css/bootstrap-editable.css'); ?>
        <?php echo Phalcon\Tag::stylesheetLink('b3/vendors/css/jquery.gritter.css'); ?>
