...
<xslt:param name="XFCrtLocalDate">2013-04-15</xslt:param>
<xslt:param name="XFCrtLocalTime">11:29:06</xslt:param>
<xslt:param name="XFCrtLocalDateTime">2013-04-15T11:29:06</xslt:param>
<xslt:param name="XFCrtUTCDate">2013-04-15</xslt:param>
<xslt:param name="XFCrtUTCTime">14:29:06</xslt:param>
<xslt:param name="XFCrtUTCDateTime">2013-04-15T14:29:06</xslt:param>
...
<fo:layout-master-set>
		<fo:simple-page-master master-name="Letter Page" page-width="11in" page-height="8.5in">
...
<fo:block><fo:table border-collapse="collapse" width="642px" table-layout="fixed" background-image="url(carnet_target_V5.png)" height="215px" background-repeat="no-repeat">
<fo:table-column column-width="642px" column-number="1"/>
<fo:table-body>
<fo:table-row height="215px">
                <fo:table-cell border="1pt solid black" padding="2pt" border-bottom-style="hidden" border-left-style="hidden" border-right-style="hidden" border-top-style="hidden">
                  <fo:block><fo:block-container z-index="1" position="absolute" left="3.500in" top="1.730in" width="1.199in" height="0.146in" overflow="hidden">
...
<fo:table-body>
<fo:table-row>
                <fo:table-cell border="1pt solid black" padding="2pt" font-family="Arial" font-size="6pt" display-align="after" text-align="center" border-bottom-style="hidden" border-left-style="hidden" border-right-style="hidden" border-top-style="hidden">
                  <fo:block>
<xsl:if test="string(expedicion/mesexpedicion)"><fo:inline>
<xsl:value-of select="expedicion/mesexpedicion"/>
</fo:inline></xsl:if>
</fo:block>
                </fo:table-cell><fo:table-cell border="1pt solid black" padding="2pt" font-family="Arial" font-size="6pt" display-align="after" text-align="center" border-bottom-style="hidden" border-left-style="hidden" border-right-style="hidden" border-top-style="hidden">
                  <fo:block>
<xsl:if test="string(expedicion/anoexpedicion)"><fo:inline>
<xsl:value-of select="expedicion/anoexpedicion"/>
</fo:inline></xsl:if>
</fo:block>
                </fo:table-cell></fo:table-row>
</fo:table-body>
</fo:table>&#160;</fo:block>
</fo:block-container><fo:block-container z-index="1" position="absolute" left="4.100in" top="0.20in" width="1.517in" height="0.437in" overflow="hidden">
<fo:block><fo:table border-collapse="collapse" width="100%" table-layout="fixed">
<fo:table-column column-width="proportional-column-width(100)" column-number="1"/>
<fo:table-body>
<fo:table-row>
                <fo:table-cell border="1pt solid black" padding="2pt" background-color="rgb(255,255,255)" border-bottom-style="hidden" border-left-style="hidden" border-right-style="hidden" border-top-style="hidden">
                  <fo:block text-align="center">

					<!--
					CODIGO DE BARRAS ORIGINAL
<xf:barcode type="Code128" xf:value="" draw-text="false" rotation="0" fo:id="D658D7C7">
<xslt:attribute name="xf:compat-id">id1524672<xslt:value-of select="generate-id(.)"/></xslt:attribute>
<xslt:if test="position() &gt; 1">
<xslt:attribute name="fo:id">
<xslt:value-of select="concat('D658D7C7_', position())"/>
</xslt:attribute>
</xslt:if>
<xsl:attribute name="value">
<xsl:value-of select="infopersonal/documento"/>
</xsl:attribute>
</xf:barcode>
...
<fo:instream-foreign-object>
    <barcode:barcode
          xmlns:barcode="http://barcode4j.krysalis.org/ns" message="{barcode/barcode}" orientation="0">
      <barcode:code39>
...
</fo:table><fo:block-container z-index="1" position="absolute" left="5.300in" top="1.690in" width="0.917in" height="0.249in" overflow="hidden">
<fo:block><fo:table border-collapse="collapse" width="100%" table-layout="fixed">
<fo:table-column column-width="proportional-column-width(100)" column-number="1"/>
<fo:table-body>
<fo:table-row>
                <fo:table-cell border="1pt solid black" padding="2pt" display-align="after" text-align="center" border-bottom-style="hidden" border-left-style="hidden" border-right-style="hidden" border-top-style="hidden">
                  <fo:block>
<xsl:if test="string(expedicion/ciudadexpedicion)"><fo:inline font-family="Arial" font-size="6pt">
<xsl:value-of select="expedicion/ciudadexpedicion"/>
</fo:inline></xsl:if>
</fo:block>
                </fo:table-cell></fo:table-row>
</fo:table-body>
</fo:table>&#160;</fo:block>
</fo:block-container><fo:block-container z-index="1" position="absolute" left="1.264in" top="1.610in" width="1.928in" height="0.439in" overflow="hidden">
<fo:block><fo:table border-collapse="collapse" width="100%" table-layout="fixed">
<fo:table-column column-width="proportional-column-width(100)" column-number="1"/>
<fo:table-body>
<fo:table-row>
                <fo:table-cell border="1pt solid black" padding="0pt" font-family="Arial" font-size="7pt" display-align="after" text-align="right" border-bottom-style="hidden" border-left-style="hidden" border-right-style="hidden" border-top-style="hidden">
                  <fo:block>
<xsl:if test="string(infopersonal/nombre)"><fo:inline>
<xsl:value-of select="infopersonal/nombre"/>
</fo:inline></xsl:if>
</fo:block>
                </fo:table-cell></fo:table-row>
<fo:table-row>
                <fo:table-cell border="1pt solid black" padding="2pt" font-family="Arial" font-size="8pt" display-align="after" text-align="right" border-top-style="hidden" border-right-style="hidden" border-left-style="hidden" border-bottom-style="hidden">
                  <fo:block>Doc. Identidad:&#160;<xsl:if test="string(infopersonal/documento)"><fo:inline>
<xsl:value-of select="infopersonal/documento"/>
